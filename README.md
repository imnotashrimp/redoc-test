...
[![Build Status](https://travis-ci.org/imnotashrimp/redoc-test.svg?branch=master)](https://travis-ci.org/imnotashrimp/redoc-test)
...
6. If you did everything correct, https://imnotashrimp.github.io/redoc-test/ will lead to your new docs
...
- Documentation(ReDoc): https://imnotashrimp.github.io/redoc-test/
- SwaggerUI: https://imnotashrimp.github.io/redoc-test/swagger-ui/
- Look full spec:
    + JSON https://imnotashrimp.github.io/redoc-test/swagger.json
    + YAML https://imnotashrimp.github.io/redoc-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://imnotashrimp.github.io/redoc-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://imnotashrimp.github.io/redoc-test/ with url from the message: `Server started <url>`
